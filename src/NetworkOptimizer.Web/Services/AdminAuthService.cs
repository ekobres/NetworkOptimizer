...
public class AdminAuthService
{
    ...
    private async Task RefreshCacheIfNeededAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            // Check database first (both regular and auto-generated passwords)
            ...
            if (dbSettings?.HasPassword == true)
            {
                ...
                if (!string.IsNullOrEmpty(decryptedPassword))
                {
                    ...
                    // Check if this was auto-generated (disabled means auto-generated)
                    _cachedSource = dbSettings.Enabled
                        ? AdminPasswordSource.Database
                        : AdminPasswordSource.AutoGenerated;
                    _lastRefresh = DateTime.UtcNow;
                    _logger.LogDebug("Using {Source} admin password",
                        _cachedSource == AdminPasswordSource.Database ? "database-stored" : "auto-generated");
                    return;
                }
            }
