...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.AuditResult", b =>
                {
                    ...
                    b.HasIndex("SiteId", "AuditDate");

                    b.HasIndex("SiteId", "DeviceId", "AuditDate");
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.Iperf3Result", b =>
                {
                    ...
                    b.HasIndex("SiteId", "TestTime");

                    b.HasIndex("SiteId", "DeviceHost", "TestTime");
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.SqmBaseline", b =>
                {
                    ...
                    b.HasIndex("SiteId", "DeviceId", "InterfaceId")
                        .IsUnique();
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.UpnpNote", b =>
                {
                    ...
                    b.HasIndex("SiteId", "HostIp", "Port", "Protocol")
                        .IsUnique();
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.AuditResult", b =>
                {
                    b.HasOne("NetworkOptimizer.Storage.Models.Site", "Site")
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.DeviceSshConfiguration", b =>
                {
                    b.HasOne("NetworkOptimizer.Storage.Models.Site", "Site")
                        .WithMany("DeviceSshConfigurations")
                        .HasForeignKey("SiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.GatewaySshSettings", b =>
                {
                    b.HasOne("NetworkOptimizer.Storage.Models.Site", "Site")
                        .WithOne("GatewaySshSettings")
                        .HasForeignKey("NetworkOptimizer.Storage.Models.GatewaySshSettings", "SiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.UniFiConnectionSettings", b =>
                {
                    b.HasOne("NetworkOptimizer.Storage.Models.Site", "Site")
                        .WithOne("ConnectionSettings")
                        .HasForeignKey("NetworkOptimizer.Storage.Models.UniFiConnectionSettings", "SiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.UniFiSshSettings", b =>
                {
                    b.HasOne("NetworkOptimizer.Storage.Models.Site", "Site")
                        .WithOne("UniFiSshSettings")
                        .HasForeignKey("NetworkOptimizer.Storage.Models.UniFiSshSettings", "SiteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NetworkOptimizer.Storage.Models.Site", b =>
                {
                    ...
                    b.Navigation("DeviceSshConfigurations");

                    b.Navigation("DismissedIssues");

                    b.Navigation("GatewaySshSettings");

                    b.Navigation("Iperf3Results");

                    b.Navigation("ModemConfigurations");

                    b.Navigation("SqmBaselines");

                    b.Navigation("SqmWanConfigurations");

                    b.Navigation("UniFiSshSettings");

                    b.Navigation("UpnpNotes");
                });
